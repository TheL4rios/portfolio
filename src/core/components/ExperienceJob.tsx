...
export const ExperienceJob = ({ experience, index }: { experience: WorkExperience; index: number; }) => {
    return (
        <div className='flex items-start justify-center flex-row md:px-5 sm:mx-auto relative pt-5'>
            <div className={ `w-[58px] h-[58px] md:w-[90px] md:h-[90px] absolute left-[15px] md:left-1/2 -ml-[43px] bg-[#343230] rounded-full flex justify-center items-center border-4 border-white ${ experience.isCurrent ? 'pulse' : '' }` }>
